...
import logoAdobeI from "../assets/img/Adobe illustrator.png";
import logoAdobeP from "../assets/img/Adobe Photoshop.png";
import logoFigma from "../assets/img/Figma.png";
import logoGolang from "../assets/img/Golang.png";
import logoJava from "../assets/img/JavaScript.png";
import logoLaravel from "../assets/img/Laravel.png";
import logoMarvel from "../assets/img/Marvel App 1.png";
import logoNode from "../assets/img/Node Js.png";
import logoPhp from "../assets/img/PHP.png";
import logoReact from "../assets/img/React Native.png";
import logoZeplin from "../assets/img/zeplin 1.png";
import upArrow from "../assets/img/up arrow.png";
import ourCustomer from "../assets/img/our-costumer 1.png";
        ...
        >
          ...
          <main className="flex-1 flex flex-col justify-center items-center text-center mt-8 px-4 w-full animate-fadein">
            ...
            <motion.a
              ...
              className="bg-[#E86A1c] hover:bg-[#d45d13] text-white font-semibold rounded-xl px-10 py-4 text-lg shadow-[0_6px_0_0_#b45309] transition w-auto flex items-center gap-4"
              variants={fadeUp}
              initial="hidden"
              animate="visible"
          ...
          >
            <div className="flex flex-col lg:flex-row gap-5 w-full max-w-10xl">
              ...
              <motion.div
                ...
                className="bg-white rounded-[20px] p-8 flex-1 flex flex-col shadow-[0_4px_0_0_black]"
              >
                <img
                  src={maps}
                  alt="Yogyakarta Map"
                ...
                <div className="text-gray-700 mb-6 text-justify">
                  Saat ini kantor utama Konnco Studio berada di kota Yogyakarta.
                  Di mana Yogyakarta merupakan kota yang nyaman dengan
                  penduduknya yang ramah serta talenta teknologi yang mumpuni.
                </div>
                ...
                <a
                  ...
                  className="bg-[#e86a1c] text-white hover:bg-[#d45d13] font-semibold rounded-xl px-8 py-3 text-lg shadow-[0_6px_0_0_#b45309] transition w-fit mx-auto flex items-left gap-2"
                >
                  Lihat Map
                </a>
              </motion.div>
              ...
              <motion.div
                ...
                className="bg-white rounded-[32px] p-8 flex-1 flex flex-col shadow-[0_4px_0_0_black] text-left max-h-[700px] md:overflow-auto overflow-visible"
              >
                ...
                <div className="text-gray-700 mb-6 text-justify">
                  Secara konsisten kami mempelajari teknologi terbaik agar dapat
                  terus berinovasi dan memberikan solusi terbaik untuk partner
                  bisnis kami. Kami juga membantu komunitas teknologi di sekitar
                  kami bertumbuh dengan berbagi ilmu dan pengalaman kami.
                </div>
                ...
                <div className="text-gray-700 text-justify">
                  ...
                  <span className="font-bold">SOLUSI TERBAIK</span> berdasarkan
                  Timeline, Budget, dan kebutuhan mereka. Startup bekerja sama
                  dengan kami karena kami memadukan Pengalaman, Kreativitas, dan
                  Kemampuan Teknis yang telah kami kumpulkan selama 8 tahun ini
                  sehingga dapat membuat mereka scale up dengan lebih cepat!
                </div>
              </motion.div>
            </div>
          </motion.section>
          ...
          >
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-4">
                <div className="text-xl font-bold text-[#E86A1C] mb-2">
                  Our Services
                </div>
                ...
                <div className="text-gray-900 text-lg max-w-2xl mx-auto">
                  Kami menawarkan layanan pengembangan perangkat lunak dengan
                  kualitas tinggi. Dengan pengalaman dan pengetahuan dalam model
                  bisnis yang umum hingga yang spesifik. Standar layanan kami
                  meliputi Great Design, Best UX sampai Excellent Maintenance.
                </div>
              </div>
            ...
            <div className="max-w-8xl mx-auto px-4">
              ...
              >
                ...
                <div className="text-base md:text-lg text-gray-200 mb-6 text-center max-w-3xl mx-auto">
                  Tidak ada tantangan yang tidak dapat dilewati oleh engineer
                  kami. Kami berfokus pada bahasa pemrograman dan framework yang
                  mumpuni seperti React, Laravel, NodeJS, Go.
                </div>
              ...
              >
                ...
                <div className="text-base md:text-lg text-gray-200 mb-6 text-center max-w-3xl mx-auto">
                  Bekerja dengan desainer terbaik. Kami memberikan desain yang
                  unik, minimalis dan memiliki fungsional yang baik, dengan
                  pengguna sebagai titik awal pembuatan desain.
                </div>
            ...
            <div className="max-w-5xl mx-auto px-4">
              <div className="text-center mb-6">
                ...
                >
                  ...
                  mengatur taskingnya dengan Sprint dan Reporting yang dilakukan
                  setiap hari.
                </motion.div>
              </div>
              {/* Responsive Workflow */}
              <div className="relative flex flex-col items-center mt-16 min-h-[340px]">
                ...
                <motion.div
                  ...
                  whileInView="visible"
                  viewport={{ once: true, amount: 0.2 }}
                  className="hidden md:block absolute left-1/3 top-[65%] -translate-x-1/2 z-10"
                >
                ...
                <motion.img
                  ...
                  src={upArrow}
                  alt="Arrow"
                  className="hidden md:block absolute left-[16%] top-[50%] w-[140px] rotate-[60deg]"
                  style={{ zIndex: 1 }}
                />
                {/* Arrow Planning -> Execute */}
                <motion.img
                  variants={fadeUp}
                  initial="hidden"
                  whileInView="visible"
                  ...
                  src={upArrow}
                  alt="Arrow"
                  className="hidden md:block absolute right-[18%] top-[60%] w-[140px]"
                ...
                <div className="flex flex-col gap-6 w-full md:hidden">
                  ...
                  >
                    <div className="text-white text-2xl font-bold mb-1">01</div>
                  ...
                  <motion.div
                    ...
                    className="bg-[#E86A1C] rounded-2xl shadow-[0_5px_0_0_#b45309] px-8 py-6 text-left"
                  >
                    <div className="text-white text-2xl font-bold mb-1">02</div>
                    <div className="text-black text-xl font-bold mb-1">
                      Planning
                    </div>
                  </motion.div>
                  ...
                  <motion.div
                    ...
                    className="bg-[#E86A1C] rounded-2xl shadow-[0_5px_0_0_#b45309] px-8 py-6 text-left"
                  >
                    <div className="text-white text-2xl font-bold mb-1">03</div>
                    <div className="text-black text-xl font-bold mb-1">
                      Execute
                    </div>
                  </motion.div>
          ...
          {/* Clients Section */}
          <section className="w-full pt-20 pb-0 bg-[#E86A1C]">
            <motion.div
              ref={clientsRef}
              variants={fadeUp}
              initial="hidden"
            ...
            >
              ...
              >
                ...
                <div className="text-white text-lg max-w-3xl mx-auto leading-relaxed">
                  ...
                  pendidikan, dan banyak lagi. Kami telah mengerjakan berbagai
                  macam proyek dari Indonesia, Asia Tenggara dan juga Eropa
                  mulai dari perusahaan kelas menengah dan juga Start Up.
                </div>
              </motion.div>
              <motion.div
                variants={fadeUp}
              ...
              >
                <img
                  src={ourCustomer}
                  alt="Our Clients"
                  className="rounded-3xl shadow-lg w-full max-w-4xl bg-white p-4"
